...
import { collectFriOpenings, friShardUnlockings, openingPairsBlob, packedWithPairs } from "./fri-openings.ts";
import {
...
import { compileFoldLockP2sh32, foldKernelCount, foldKernelUnlocking, foldQueriesPerKernel } from "./fold-kernel.ts";
