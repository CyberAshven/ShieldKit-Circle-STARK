/**
 * Lab oracle: JS verifyFri and CashVM standard=false on the occupancy lock.
 * Occupancy is FRI10 / QM31 124-bit; leftover SHA-LDE is not wired.
...
export function runCorrespondenceOracle(): {
  ...
  rows.push({
    name: "honest B",
    js: jsH.ok,
    vm: vmH.accepted && meters.inputs.every((i) => i.accepted),
