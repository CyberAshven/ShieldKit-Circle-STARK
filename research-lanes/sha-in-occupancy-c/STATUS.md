# Status (copied parent log — not this lane’s product)

**This lane’s constitution is [`RULES.md`](RULES.md). No vk yet.** See [`ARGUMENT.md`](ARGUMENT.md), [`GOAL.md`](GOAL.md), [`START.md`](START.md).

Start is the occupancy + HASH_BIT host at `1b18a98` (Chipnet `5de68272…`, 99144 B). That host is evidence. It is not SHA-in-occupancy-C.

The text below is the **parent freeze tree’s** status as copied on 2026-08-23. It describes vk `circle-fri-m31-t64-b16-q36-g20-fri9` (M31, preimage-in-unlocking). That freeze is evidence. It is **not** B under RULES.md.
