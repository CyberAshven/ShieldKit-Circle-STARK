...
RECEIPT_LAUNCHER_ID = "cpsb-exact27-diagnostic-v1"
EXPECTED_MANIFEST_BYTES = 237_511
EXPECTED_MANIFEST_SHA256 = (
    "8c6ce4d08fd219accac6786257fb58ecd22936cb15dbc49b8de865bb73a9a0de"
)
EXPECTED_TOTAL = 673
EXPECTED_TOTAL_BYTES = 174_467_025
EXPECTED_ORDERED_ROW_DIGEST = (
    "52efb791744ca73450d3164a6948060c753e0fd5fc4039076b2e3a5d7f5edd1d"
)
...
def output_record(
    ...
    *,
    ...
    """Canonical output evidence without treating it as a validation result."""
    ...
    if incomplete_reason is None or observed_at_least is None:
...
def diagnostic_completion(
    *,
    ...
    """Describe child termination without treating any outcome as valid."""
...
def run_validator_diagnostic(
    ...
    """Run the fixed validator and always return a bounded diagnostic record.

    Pre-spawn and reaping failures stay outer bootstrap rejections.  A timeout
    or byte 65,537 instead kills and reaps the child, then becomes a
    noncomplete diagnostic record rather than an acceptance or retry path.
    """
    try:
