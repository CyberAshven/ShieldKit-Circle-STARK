...
export const queryKatSummary = (kat) => Object.freeze({
  ...
  transactionInputCountRuntimeBound: kat.fixture.transactionInputCountRuntimeBound,
...
export const multiQueryKatSummary = (kat) => Object.freeze({
  ...
  transactionInputCountRuntimeBound: kat.fixtures.every(({ transactionInputCountRuntimeBound }) => transactionInputCountRuntimeBound),
