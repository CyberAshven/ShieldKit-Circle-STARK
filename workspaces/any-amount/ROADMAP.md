...
4. **Statistical ZK** — published preimage OTP; FRI openings/packed Q offset by a degree-0 mask (lock subtracts it). Packed Newton T still public. Not better-than-XMR.
