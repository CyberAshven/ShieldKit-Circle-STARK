...
- More than one FS query folded per redeem (density). Viewing-key delivery / wallet UX. Full DEEP-ALI mask of the FRI polynomial (openings are still of public `onChainCells`).
