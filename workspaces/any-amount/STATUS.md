...
- One-successor N-payout batch (sum of shuffled P2PKH = abs-net). Opt-in wait + CashFusion-shaped sketch is shipped; the redeem still HASH256-binds output 1.
