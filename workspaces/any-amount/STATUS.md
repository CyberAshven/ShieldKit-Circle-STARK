...
**Milestones (Chipnet):** hash-knob + Q/N opening-mask pack standard successor `f14bff7b…` (**79436 B**, 1 fold, Electrum). Intermediate `c40f4948…` (**99742 B**) stays recorded. Prior opening-mask lands stay: `617b1022…` (**98979 B**) and `b3ea8a75…` (**383031 B**, 36 folds). Pre-mask lands stay: `2acb1196…`, `b1415faf…` (319402), `18c74b49…`, `356630bd…`. Details: [`MILESTONE.md`](MILESTONE.md).
