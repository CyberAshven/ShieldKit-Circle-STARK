...
- More than one FS query folded per redeem (density). Viewing-key delivery / wallet UX. Secret (non-recoverable) FRI-polynomial mask — packed Newton T still lets an observer recover the degree-0 opening offset.
