...
Published note preimage is one-time-padded. **Not** a Lean theorem, **not** mainnet, **not** better-than-XMR or Zcash (SHA-256 does not change that). The shipped lock **requires**
