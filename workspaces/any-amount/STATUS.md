...
**36** slots. Envelope **C** is a pre-signed unconfirmed **chain** (default 3 hops,
ceiling 320 × 100 KB ≈ 32 MB): tape hops commit `TAPE1`+digest and never pay;
the last hop spends the pool and the tape tip. BCHN still takes one tx at a
time (no Core 1p1c blob). CLI: `--envelope a|b|c`.

**Milestones (Chipnet):** envelope **A** `05f17bf1…` (**82365 B**, Electrum), envelope **B** `b6818bd2…` (**479356 B**, JSON-RPC mempool), envelope **C** tape `6d242fee…`/`ec4cd5b3…` + pay `6f9fd1d0…` (**82506 B**). Prior post-plugin standard `23fd1b7d…` (**79525 B**) and consensus `9362df54…` (**283992 B**) stay recorded, as do `f14bff7b…`, `c40f4948…`, `617b1022…`, `b3ea8a75…`, `2acb1196…`, `b1415faf…`, `18c74b49…`, `356630bd…`. Details: [`MILESTONE.md`](MILESTONE.md).
