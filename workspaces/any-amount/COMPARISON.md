...
- Hidden individual note amounts on the UTXO (pool output is a constant `STATE_BASE`; reserve is not in the NFT). The public net is a hiding tagged hash in `encodeStatement`, not Bulletproofs/Orchard, and is not published as a successor i64.
