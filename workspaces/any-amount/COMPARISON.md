...
| On-chain verify | BCH 2026 VM: packed AIR + 10 Merkle + bind-T + **1** fold + **6** C=QZ (≤100 KB) or **36** folds + **36** C=QZ (≤1 MB, measured 382203 B). Digest / dummy / wrong-fold-index (incl. query 10) fail. Chipnet 10-fold land `18c74b49…` is not the 36-fold compile. | Consensus ring/BP | Consensus SNARK | L2 rollup circuits | Solana Groth16 verifier ELF | Ethereum Groth16 verifier |
...
- Statistical ZK. Unlocking still carries packed openings.
